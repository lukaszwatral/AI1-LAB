...
function fetchWeather() {
    ...
    if (city !== "") {
        ...
        req.onload = function () {
            ...
            windElement.innerHTML = `<img src="./flaticon/wind.png" alt="wind"><h5 id="wind">${wind} m/s</h5>`;

            let pressureElement = document.createElement("div");
            pressureElement.className = "weatherStats";
            pressureElement.innerHTML = `<img src="./flaticon/pressure.png" alt="pressure"><h5 id="pressure">${pressure} hPa</h5>`;

            let humidityElement = document.createElement("div");
            humidityElement.className = "weatherStats";
            humidityElement.innerHTML = `<img src="./flaticon/humidity.png" alt="humidity"><h5 id="humidity">${humidity}%</h5>`;
        ...
        fetch(`https://api.openweathermap.org/data/2.5/forecast?q=${city}&appid=${apiKey}&units=metric`)
            ...
            .then((data) => {
                ...
                data.list.forEach((forecast) => {
                    ...
                    let dayKey = date.toLocaleDateString('en-US', {weekday: 'short', month: 'long', day: 'numeric'});
                    ...
                    let iconElement = document.createElement("img");
                    iconElement.id = "icon";
                    iconElement.src = `http://openweathermap.org/img/w/${forecast.weather[0].icon}.png`;
                    iconElement.alt = "icon";
                    ...
                    let windElement = document.createElement("div");
                    windElement.className = "weatherStats";
                    windElement.innerHTML = `<img src="./flaticon/wind.png" alt="wind"><h5 id="wind">${forecast.wind.speed} m/s</h5>`;

                    let pressureElement = document.createElement("div");
                    pressureElement.className = "weatherStats";
                    pressureElement.innerHTML = `<img src="./flaticon/pressure.png" alt="pressure"><h5 id="pressure">${forecast.main.pressure} hPa</h5>`;

                    let humidityElement = document.createElement("div");
                    humidityElement.className = "weatherStats";
                    humidityElement.innerHTML = `<img src="./flaticon/humidity.png" alt="humidity"><h5 id="humidity">${forecast.main.humidity}%</h5>`;
